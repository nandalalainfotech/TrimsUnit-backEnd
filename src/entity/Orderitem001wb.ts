...
export class Orderitem001wb {
  ...
  @JoinTable({
    name: "orderitempurchase001mb",
    joinColumns: [{ name: "orderitem001wb", referencedColumnName: "slNo" }],
    inverseJoinColumns: [
      { name: "purchaseorder001wb", referencedColumnName: "slNo" },
    ],
    schema: "trims",
  })
  ...
  setProperties(orderItemwbDTO: OrderItemwbDTO) {
    ...
    this.unitdepartslNo=orderItemwbDTO.unitdepartslNo;
