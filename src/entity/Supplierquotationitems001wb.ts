...
export class Supplierquotationitems001wb {
  ...
  @JoinTable({
    name: "supplierquotaitem001mb",
    joinColumns: [
      { name: "supplierquotationitems001wb", referencedColumnName: "slNo" },
    ],
    inverseJoinColumns: [
      { name: "supplierquotation001wb", referencedColumnName: "slNo" },
    ],
    schema: "trims",
  })
  ...
  setProperties(supplierquotationsItemDTO: SupplierquotationsItemDTO) {
    ...
    this.unitdepartslNo=supplierquotationsItemDTO.unitdepartslNo;
