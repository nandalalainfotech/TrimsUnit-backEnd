...
export class OrderItemMbService {
    ...
    async create(orderItemMbDTO: OrderItemMbDTO): Promise<Orderitem001mb> {
        ...
        return this.orderItemsRepository.save(orderitem001mb);
    }
    ...
    async findAll(): Promise<Orderitem001mb[]> {
    ...
    findOne(orderslno: number): Promise<Orderitem001mb> {
        return this.orderItemsRepository.findOne(orderslno);
    }
    ...
    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        ...
        let item = await this.orderItemsRepository.find();
