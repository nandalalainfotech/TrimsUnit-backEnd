...
export class SuppchecklistService {
    ...
    async findAll(): Promise<Suppchecklist001mb[]> {
        return await this.SuppchecklistRepository.find({ relations: ["activityslNo2"] });
    }
 ...
 async downloadPdf(@Req() request: Request, @Res() response: Response) {
        ...
        let suplcheckl = await this.SuppchecklistRepository.find({ relations: ["activityslNo2"] });
