...
export class SuppliertrainingService {
    ...
    async findAllBySupplierId(supregslno: number): Promise<Suppliertrainingplan001wb[]> {
        return this.SuppliertrainingRepository.find({ relations: ["supregslNo2", "trainingslNo2"], where: { "supregslNo": supregslno } });
    }

    async findAll(): Promise<Suppliertrainingplan001wb[]> {
        return await this.SuppliertrainingRepository.find({ relations: ["supregslNo2", "trainingslNo2"] });
    }
    ...
    async NotificationAll(): Promise<Suppliertrainingplan001wb[]> {
