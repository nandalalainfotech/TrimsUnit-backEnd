...
export class SupplierRegistrationService {
    ...
    async findAll(): Promise<Supplierregistration001mb[]> {
        return this.supplierRegRepository.find();
    }

    async findAllSlNoAndSuppcode(): Promise<Supplierregistration001mb[]> {
        return this.supplierRegRepository.find({select : ['slNo', 'supplierName','supplierCode']});
    }
 ...
 async downloadPdf(@Req() request: Request, @Res() response: Response) {
        let suplreg: any[] = await this.supplierRegRepository.find({
    ...
    async downloadExcel(@Req() request: Request, @Res() response: Response) {
        let suplreg = await this.supplierRegRepository.find({
        });
