...
export class PreventivePlanService {
    ...
    async findNotificationAll(): Promise<Preventiveplan001wb[]> {
    ...
    async findAllByMachineId(mslno: number): Promise<Preventiveplan001wb[]> {
        return this.preplanRepository.find({ relations: ["mslno2"], where: { "mslno": mslno } });
    }
