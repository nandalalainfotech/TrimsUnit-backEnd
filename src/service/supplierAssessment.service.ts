...
export class SupplierAssessmentService {
    ...
    async findAll(): Promise<Supplierassessment001wb[]> {
        return this.supplierAssessRepository.find( { relations: ["assessSlno2","suppSlno2"]});
    }

    async findAllBySupplierId(suppSlno: number): Promise<Supplierassessment001wb[]> {
        return this.supplierAssessRepository.find({ relations: ["assessSlno2", "suppSlno2"], where: { "suppSlno": suppSlno } });
    }
