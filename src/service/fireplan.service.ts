...
export class FirePlanService {
    ...
    async findNotificationAll(): Promise<Fireplan001wb[]> {
    ...
    async findAll(): Promise<Fireplan001wb []> {
        return await this.fireRepository.find();
    }
    ...
    async downloadPdf(@Req() request: Request, @Res() response: Response) {
        let firepl = await this.fireRepository.find();
